...
class SydneyLoader(BaseHypnetLoader):
    def __init__(self, tokenizer, train_args, model_name, is_instruct):
        self.max_new_tokens = 22
        self.dataset_name = 'sydney'
        self.PATH = 'data/sydney' 
        self.modality = 'satellite'
        self.id_type = 'imageid'
        self.emb_name = 'emb'
        self.CAPS_PER_IMAGE = 5
